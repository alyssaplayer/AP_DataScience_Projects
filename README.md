...
The Colour Palette script automatically extracts a colour palette from any image using the K-Means clustering algorithm. It includes an added accessibility function recommending whether the supporting font should be black or white. 
